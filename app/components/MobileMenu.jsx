...
const MobileMenu = ({ products }) => {
  ...
  return (
    <div className="md:hidden">
      <div className=" h-16 relative flex flex-row items-center justify-around theme-main-color">
        <div
          id="mobileMenuToggle"
        ...
        >
          <div
            className={`${
              mobileMenuVisible
                ? ""
                : "fa fa-bars fa-lg text-white theme-bg-color p-2"
            }`}
          ></div>
        </div>
        <div className="theme-text-color font-bold">
          <div>گروه جاویدان صنعت</div>
        </div>
        <Link href="/" className="text-lg cursor-pointer">
          <img src="/30-reduced.png" className=" w-12 h-12" />
        </Link>
      </div>
      <div
